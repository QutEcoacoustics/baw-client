    ...
    methods.setBox = function setBox(id, top, left, height, width, selected) {
        return this.each(function () {
            ...
            if (matchingBoxElement) {
                matchingBoxElement.style.width = width + "px";
                matchingBoxElement.style.height = height + "px";
                matchingBoxElement.style.top = top + "px";
                matchingBoxElement.style.left = left + "px";

                if (selected && selected === true) {
                    matchingBoxElement.setAttribute(SELECTED_ATTRIBUTE, true);
                }
            }
            else {
