<a name="1.5.2"></a>
## [1.5.2](https://github.com/QutBioacoustics/baw-client/compare/v1.5.1...v1.5.2) (2020-08-06)


### Bug Fixes

* **auth:** remove auth token from query string for media requests to a different host ([a3d458e](https://github.com/QutBioacoustics/baw-client/commit/a3d458e))
* **authHttpInterceptor:** Don't send Auth token for requests to other hosts. ([8128505](https://github.com/QutBioacoustics/baw-client/commit/8128505))
* **background:** when no background should be displayed removes any background ([cd7078c](https://github.com/QutBioacoustics/baw-client/commit/cd7078c))
* **build:** change the location of static assets for citizen science ([201609b](https://github.com/QutBioacoustics/baw-client/commit/201609b))
* **citSci:** citizen science pages redirect if user not logged in ([a775642](https://github.com/QutBioacoustics/baw-client/commit/a775642))
* **citSci:** fix ng-target attribute on citSci landing page ([ab9d1af](https://github.com/QutBioacoustics/baw-client/commit/ab9d1af))
* **citSci:** get started link to use target self if linking to login ([cb26b5d](https://github.com/QutBioacoustics/baw-client/commit/cb26b5d))
* **citSci:** removed reference to constructor name, which breaks on minification ([0259e77](https://github.com/QutBioacoustics/baw-client/commit/0259e77))
* **citSci:** small css layout tweak to citizen science landing pages ([ec95fb7](https://github.com/QutBioacoustics/baw-client/commit/ec95fb7))
* **citSci:** updates to dataset item paging, dataset progress ([a5a8d51](https://github.com/QutBioacoustics/baw-client/commit/a5a8d51))
* **listen:** Listen page now supports public access ([0921c57](https://github.com/QutBioacoustics/baw-client/commit/0921c57)), closes [#298](https://github.com/QutBioacoustics/baw-client/issues/298)
* **media:** do not append auth token to url for other domains ([f207d32](https://github.com/QutBioacoustics/baw-client/commit/f207d32))

### Features

* **auth:** hacking support for public access ([4f22e82](https://github.com/QutBioacoustics/baw-client/commit/4f22e82))
* **citizenScience:** background and styling for citizen science about page ([79257c8](https://github.com/QutBioacoustics/baw-client/commit/79257c8))
* **citizenScience:** Next sample button text depends on responses ([bc8c1cb](https://github.com/QutBioacoustics/baw-client/commit/bc8c1cb))
* **citizenScience:** responses page for viewing locally saved responses ([fa3135b](https://github.com/QutBioacoustics/baw-client/commit/fa3135b))
* **citizenScience:** styling of next sample button ([bf7a755](https://github.com/QutBioacoustics/baw-client/commit/bf7a755))
* **citizenScienceExamples:** alignment and spacing of bird images. Hide image if screen too narrow ([f78c27b](https://github.com/QutBioacoustics/baw-client/commit/f78c27b))
* **citizenScienceExamples:** bird image ([f3b8c18](https://github.com/QutBioacoustics/baw-client/commit/f3b8c18))
* **citsci:** checkbox component updated for text-only label selection and 'maybe' option ([9f1210a](https://github.com/QutBioacoustics/baw-client/commit/9f1210a))
* **citsci:** Improved onboarding walkthough. ([8952909](https://github.com/QutBioacoustics/baw-client/commit/8952909))
* **citSci:** added ability for example annotations to come from a different domain ([82f10d7](https://github.com/QutBioacoustics/baw-client/commit/82f10d7))
* **citSci:** added ability to have  text fields in questions ([75ae0fa](https://github.com/QutBioacoustics/baw-client/commit/75ae0fa))
* **citSci:** added dataset item info to citizen science UI ([9d47ade](https://github.com/QutBioacoustics/baw-client/commit/9d47ade))
* **citSci:** added dataset progress information (in progress) ([89bfdde](https://github.com/QutBioacoustics/baw-client/commit/89bfdde))
* **citSci:** added label text overlay on thumbnails ([8ebc491](https://github.com/QutBioacoustics/baw-client/commit/8ebc491))
* **citSci:** added small checkbox on top of thumb label ([2509977](https://github.com/QutBioacoustics/baw-client/commit/2509977))
* **citSci:** added watcher for audio sources to reload audio on src change ([3aa81ac](https://github.com/QutBioacoustics/baw-client/commit/3aa81ac))
* **citSci:** enable autoplay, allow notes for question responses. ([50e62bf](https://github.com/QutBioacoustics/baw-client/commit/50e62bf))
* **citSci:** Finished generalising citizen science controllers and templates for use with dif ([537bcd9](https://github.com/QutBioacoustics/baw-client/commit/537bcd9))
* **citSci:** fixed text label component for use with binary label question ([400ebb7](https://github.com/QutBioacoustics/baw-client/commit/400ebb7))
* **citSci:** for annotations from different hosts, the correct absolute urls are now used for ([05270e8](https://github.com/QutBioacoustics/baw-client/commit/05270e8))
* **citSci:** formatting dataset item info and adding onboarding for those item info and progr ([4511a8c](https://github.com/QutBioacoustics/baw-client/commit/4511a8c))
* **citSci:** improve css for label check ([be83472](https://github.com/QutBioacoustics/baw-client/commit/be83472))
* **citSci:** improved progress indicator, fixed layout for thumblables when very narrow scree ([b1f9dd1](https://github.com/QutBioacoustics/baw-client/commit/b1f9dd1))
* **citSci:** labelCheck bindings to work with text labels or thumb labels ([96d7a89](https://github.com/QutBioacoustics/baw-client/commit/96d7a89))
* **citSci:** landing page loads study-specific content from a source outside the app ([c43a209](https://github.com/QutBioacoustics/baw-client/commit/c43a209))
* **citSci:** moved background images from assets to be in public (git ignored) ([cdb22e2](https://github.com/QutBioacoustics/baw-client/commit/cdb22e2))
* **citSci:** removed routing from dataset progress ([8b4fc08](https://github.com/QutBioacoustics/baw-client/commit/8b4fc08))
* **citSci:** reorganised folder structure for label components ([ca32c9a](https://github.com/QutBioacoustics/baw-client/commit/ca32c9a))
* **citSci:** small layout change for text labels ([86cf4c0](https://github.com/QutBioacoustics/baw-client/commit/86cf4c0))
* **citSci:** small tweaks to cs layout ([a0556e1](https://github.com/QutBioacoustics/baw-client/commit/a0556e1))
* **citSci:** started adding capability for questions of different shapes ([7bedaaf](https://github.com/QutBioacoustics/baw-client/commit/7bedaaf))
* **citSci:** started setBackgroundImageForItem to show best image for dataset item based on s ([c0858b7](https://github.com/QutBioacoustics/baw-client/commit/c0858b7))
* **citSci:** started setBackgroundImageForItem to show best image for dataset item based on s ([0a4ec3f](https://github.com/QutBioacoustics/baw-client/commit/0a4ec3f))
* **citSci:** style tweaks, onboarding fix,  background image fix ([8e836b7](https://github.com/QutBioacoustics/baw-client/commit/8e836b7))
* **citSci:** updated csSamples to request associated records of datasetItems, including media ([597e72a](https://github.com/QutBioacoustics/baw-client/commit/597e72a))
* **CitSci:** Record 'played' progress event. Change the way progress event service and model  ([b946ab0](https://github.com/QutBioacoustics/baw-client/commit/b946ab0))
* **CitSci:** use the filter todo endpoint to get samples, and send progress events when sampl ([3eec80a](https://github.com/QutBioacoustics/baw-client/commit/3eec80a))
* **datasets:** New wording and placement of next sample button on citizen science ([18bb027](https://github.com/QutBioacoustics/baw-client/commit/18bb027))
* **datasets:** Started work to use dataset items from the server for cs samples ([1599960](https://github.com/QutBioacoustics/baw-client/commit/1599960))
* **icon:** updated favicon ([99eef49](https://github.com/QutBioacoustics/baw-client/commit/99eef49))
* **onboarding:** Allow reinitialization of onboarding service so it can be run on different pages ([a4b2869](https://github.com/QutBioacoustics/baw-client/commit/a4b2869))
* **onboarding:** autoplay for onboarding ([d3be300](https://github.com/QutBioacoustics/baw-client/commit/d3be300))
* **onboarding:** fixed code style for onboarding autoplay changes ([43e3612](https://github.com/QutBioacoustics/baw-client/commit/43e3612))
* **questionResponses:** Citizen science uses responses to store answers to questions. ([bf8fa1c](https://github.com/QutBioacoustics/baw-client/commit/bf8fa1c))
* **questions:** Question service to use questions from server for citizen science labels ([93be50e](https://github.com/QutBioacoustics/baw-client/commit/93be50e))

### Other Notes

* changed version of node-sass so that it intalls 4.5.3 rather than the latest com ([0924020](https://github.com/QutBioacoustics/baw-client/commit/0924020))
* continue dockerizing ([9cef667](https://github.com/QutBioacoustics/baw-client/commit/9cef667))
* Continuing dockerization ([5bb9681](https://github.com/QutBioacoustics/baw-client/commit/5bb9681))
* Ensures bower dependencies are installed ([12701b5](https://github.com/QutBioacoustics/baw-client/commit/12701b5))
* Finish up dockerization ([c890ace](https://github.com/QutBioacoustics/baw-client/commit/c890ace))
* First attempt at building in docker ([16027ca](https://github.com/QutBioacoustics/baw-client/commit/16027ca))
* Fix casing in indentifiers ([4db2423](https://github.com/QutBioacoustics/baw-client/commit/4db2423))
* Hide fixed-size lower visualisation by default. ([428bf16](https://github.com/QutBioacoustics/baw-client/commit/428bf16))
* markdown formatting fix ([895c650](https://github.com/QutBioacoustics/baw-client/commit/895c650))
* Predictive caching does not assume mp3 is an available format. Fixes #327 ([52eb00b](https://github.com/QutBioacoustics/baw-client/commit/52eb00b)), closes [#327](https://github.com/QutBioacoustics/baw-client/issues/327)
* remove dataset item id routing from citizen science ([a8a4723](https://github.com/QutBioacoustics/baw-client/commit/a8a4723))
* Set autoplay to true by default ([7b7c163](https://github.com/QutBioacoustics/baw-client/commit/7b7c163))
* Tidyup and minor fixes improvements ([c8b9141](https://github.com/QutBioacoustics/baw-client/commit/c8b9141))
* Updated the hard-coded study settings ([4b46442](https://github.com/QutBioacoustics/baw-client/commit/4b46442))
