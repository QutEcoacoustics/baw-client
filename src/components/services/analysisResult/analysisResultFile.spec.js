describe("The analysis result file service", function () {
    ...
    it("can return a long duration image", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__ACI-ENT-EVN.png";
    ...
    it("can return a long duration image - of a different type", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__BGN-POW-CVR.png";
    ...
    it("ensures the subfolder argument works", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/ARBITRARY_PATH_FRAGMENT/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__BGN-POW-CVR.png";
    ...
    it("can return a long duration image tile", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__ACI-ENT-EVN.Tile_20101014-020000Z_60.png";
    ...
    it("supports sub-second datetimes for tiles", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__ACI-ENT-EVN.Tile_20101014-020000.123Z_60.png";
    ...
    it("supports sub-second datetimes for tiles and strips trailing zeros", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__ACI-ENT-EVN.Tile_20101014-020000.12Z_60.png";
    ...
    it("can return a long duration image tile - of a different resolution", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__ACI-ENT-EVN.Tile_20101014-020000Z_0.02.png";
    ...
    it("can return a long duration image tile - of a different type", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__BGN-POW-CVR.Tile_20101014-020000Z_60.png";
    ...
    it("ensures the zooming switch overrides image type", function () {
        ...
        var url = root + "/analysis_jobs/system/audio_recordings/188263/results/Towsey.Acoustic/ZoomingTiles/b03685fe-6ad5-4776-90b7-e2c271dad3fb_20101013-140000Z__BLENDED.Tile_20101014-020000Z_0.02.png";
