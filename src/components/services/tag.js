    ...
    .factory(
        ...
        [
            ...
            function ($resource, $http, bawResource, paths, _, TagModel, QueryBuilder) {
                ...
                var resource = bawResource(paths.api.routes.tag.showAbsolute, {tagId: "@tagId"}, {});
                ...
                resource.selectSinglePriorityTag = function selectSinglePriorityTag(tags) {
                    ...
                    // also: on load, only incomplete tags will be listed --> the tag resolver then runs for every tag,
                    // just below
